...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="rml/configs/object_detection/rever_furniture.yaml, "
                "rml/configs/object_detection/open_image_v7_furniture.yaml, "
                "rml/configs/object_detection/lvis_furniture.yaml",
        # metavar="N",
    ...
    parser.add_argument(
        "--data_dirs",
        type=str,
        default="/kaggle/input/furniture/furniture/furniture/rever, "
                "/kaggle/input/furniture/furniture/furniture/open_images,"
                " /kaggle/input/furniture/lvis/lvis",
        # metavar="N",
        help="data directory",
    )
