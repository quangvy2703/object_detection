...
from rml.models.vision.object_detection.yolov8.ultralytics.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding rml.vision.object_detection.models.yolov8.ultralytics classes.

        Returns:
            dict: A dictionary mapping task names to rml.vision.object_detection.models.yolov8.ultralytics task classes for the RT-DETR model.
        """
        return {
            'detect': {
