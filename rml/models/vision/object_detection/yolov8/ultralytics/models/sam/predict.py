...
using SAM. It forms an integral part of the rml.vision.object_detection.models.yolov8.ultralytics framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from rml.models.vision.object_detection.yolov8.ultralytics.data.augment import LetterBox
from rml.models.vision.object_detection.yolov8.ultralytics.engine.predictor import BasePredictor
from rml.models.vision.object_detection.yolov8.ultralytics.engine.results import Results
from rml.models.vision.object_detection.yolov8.ultralytics.utils import DEFAULT_CFG, ops
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model, verbose=True):
        ...
        parameters for image normalization and other rml.vision.object_detection.models.yolov8.ultralytics compatibility settings.
        ...
        # rml.vision.object_detection.models.yolov8.ultralytics compatibility settings
        self.model.pt = False
