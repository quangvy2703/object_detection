...
from rml.models.vision.object_detection.yolov8.ultralytics.utils.metrics import OKS_SIGMA
from rml.models.vision.object_detection.yolov8.ultralytics.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from rml.models.vision.object_detection.yolov8.ultralytics.utils.tal import TaskAlignedAssigner, dist2bbox, make_anchors
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError('ERROR ❌ segment dataset incorrectly formatted or not a segment dataset.\n'
                            ...
                            'as an example.\nSee https://docs.rml.vision.object_detection.models.yolov8.ultralytics.com/tasks/segment/ for help.') from e
