...
from rml.vision.object_detection.models.yolov8.ultralytics.models.fastsam.utils import bbox_iou
...
class FastSAMPredictor(DetectionPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in rml.vision.object_detection.models.yolov8.ultralytics
    YOLO framework.
