...
class BYTETracker:
    ...
    def sub_stracks(tlista, tlistb):
        """DEPRECATED CODE in https://github.com/rml.vision.object_detection.models.yolov8.ultralytics/rml.vision.object_detection.models.yolov8.ultralytics/pull/1890/
